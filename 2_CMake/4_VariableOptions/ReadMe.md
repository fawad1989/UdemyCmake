...
option(COMPILE_EXECUTABLE "Whether to Compile the Executable" OFF) # COMPILE_EXECUTABLE is a variable that has boolean value of OFF
...
if (COMPILE_EXECUTABLE)
    ...
    message("Without exe. compilation") #if app directory is not added then this message will show up
endif()
```
